...
- Station details
- Shot scores, hits, and misses
- Shooter names, if you choose to track other shooters
- Saved location names
- Weather snapshots associated with a tournament

This information is stored locally on your device using Apple’s local app storage. Sporting Clays does not require an account and does not upload your scoring data to our own servers.
...
Speech recognition may be processed by Apple’s speech recognition services, depending on the capabilities and settings of your device. Sporting Clays does not store audio recordings or send voice data to our own servers.
...
Use of those services may be subject to Apple’s privacy practices.

## Data Deletion

You can delete tournaments, locations, shooters, stations, and scores directly in the app. Deleting the app from your device will also remove locally stored app data, subject to normal iOS behavior such as device backups.
...
We may update this Privacy Policy if the app’s features or data practices change. Updates should reflect the current behavior of the app.
